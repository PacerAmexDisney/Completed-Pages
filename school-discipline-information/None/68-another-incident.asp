...
<div id="wrapper">
  ...
  <div id="bcrumb"> : <a id="homelink" href="/school-discipline-information/">Intro</a> &gt; <a href="/school-discipline-information/02-iep-504.asp">IEP/504/None</a> &gt; <a href="/school-discipline-information/None/55-not-on-504-iep.asp">Not on IEP/504</a> &gt; ... &gt; <a href="/school-discipline-information/None/67-following-written-request.asp">Following  Written Request</a> &gt; Another Incident Before the Evaluation was Complete</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->
  
  <div id="sectionCarryOver">
  <h3>Following my written request for an evaluation:</h3>
  <p>There  was another incident involving my child before the evaluation was completed.</p>
</div>
  
  <h2>Response:</h2>
  <p>Your  child must be treated as if he or she were entitled to special education and on  an IEP.  </p>
