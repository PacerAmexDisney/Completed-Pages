...
<meta property="og:url" content="http://www.pacer.org/school-discipline-information/None/59-requested-evaluation.asp" />
...
<!--#include virtual="/templates/page-header-nav.asp"-->
  ...
  <div id="bcrumb"> : <a id="homelink" href="/school-discipline-information/">Intro</a> &gt; <a href="/school-discipline-information/02-iep-504.asp">IEP/504/None</a> &gt; <a href="/school-discipline-information/None/55-not-on-504-iep.asp">Not on IEP/504</a> &gt; <a href="/school-discipline-information/None/58-none-of-above.asp">None of the Above</a> &gt; Requested an Evaluation</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->

<div id="sectionCarryOver">
  <h3>Before this incident:</h3>
  <p>I  requested an evaluation of my child for special education orally or in writing OR  I expressed concern in writing to an administrator that my child was in need of  special education services</p>
</div>
<h2>Response:</h2>
<p>If misconduct occurs after a parent requests an evaluation  for special education services or expresses a concern in writing that a child  may need special education services, the school must follow special education  discipline procedures as if the child were already on an IEP.<sup class="statute">1</sup><br />
  <br />
  <a href="/school-discipline-information/IEP/03-discipline-is.asp">Continue to the IEP Section &gt;&gt;&gt;</a></p>
  <div id="statutes">
  <h3>Statutes</h3>

  <ol><li><a href="http://www.gpo.gov/fdsys/search/pagedetails.action?browsePath=Title+34%2FSubtitle+B%2FChapter+III%2FPart+300%2FSubpart+E%2FHeading+244%2FSection+300.534&granuleId=CFR-2010-title34-vol2-sec300-534&packageId=CFR-2010-title34-vol2&collapse=true&fromBrowse=true" target="_blank">34  C.F.R. 300.534</a>  </li>
  </ol>
