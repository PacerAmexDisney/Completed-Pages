...
<meta property="og:url" content="http://www.pacer.org/school-discipline-information/None/57-status-pending.asp" />
...
<!--#include virtual="/templates/page-header-nav.asp"-->
  ...
  <div id="bcrumb"> : <a id="homelink" href="/school-discipline-information/">Intro</a> &gt; <a href="/school-discipline-information/02-iep-504.asp">IEP/504/None</a> &gt; <a href="/school-discipline-information/None/55-not-on-504-iep.asp">Not on IEP/504</a> &gt; Special Education Evaluation Pending</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->
  <div id="sectionCarryOver">
  <h3>The following best describes my situation:</h3>
  <p>A  request for a special education evaluation for my child was submitted prior to  this incident and is pending.</p>
</div>

  <p>Even  though the evaluation has not been completed, the school must follow special  education discipline procedures as if your child were on an IEP.</p>
