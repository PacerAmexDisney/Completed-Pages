...
<meta property="og:url" content="http://www.pacer.org/school-discipline-information/None/56-not-complete.asp" />
...
<!--#include virtual="/templates/page-header-nav.asp"-->
  ...
  <div id="bcrumb"> : <a id="homelink" href="/school-discipline-information/">Intro</a> > <a href="/school-discipline-information/02-iep-504.asp">IEP/504/None</a> &gt; <a href="/school-discipline-information/None/55-not-on-504-iep.asp">Not on IEP/504</a> &gt; Evaluation Not yet Complete</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->
  <div id="sectionCarryOver">
  <h3>The following best describes my situation:</h3>
  <p>A special education evaluation of my child began prior to this incident and is not yet complete.  </p>
  </div>

  <p>Even  though the evaluation has not been completed, the school must follow special  education discipline procedures as if your child were on an <span class="def" id="iep">IEP*</span>. </p>
  <p><a href="/school-discipline-information/IEP/03-discipline-is.asp">Continue to the IEP Section &gt;&gt;&gt;</a></p>
