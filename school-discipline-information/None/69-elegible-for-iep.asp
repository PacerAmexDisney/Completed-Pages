...
<div id="wrapper">
  ...
  <div id="bcrumb"> : <a id="homelink" href="/school-discipline-information/">Intro</a> &gt; <a href="/school-discipline-information/02-iep-504.asp">IEP/504/None</a> &gt; <a href="/school-discipline-information/None/55-not-on-504-iep.asp">Not on IEP/504</a> &gt; ... &gt; <a href="/school-discipline-information/None/67-following-written-request.asp">Following  Written Request</a> &gt; Eligible for Special Education</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->
  
  <div id="sectionCarryOver">
  <h3>Following my written request for an evaluation:</h3>
  <p>My  child was found eligible for special education services.</p>
</div>
  
  <h2>Response:</h2>
  <p>Your child must be treated as a child on an IEP, entitled to disciplinary  protection under the Individuals with Disabilities Education Act (IDEA 2004).</p>
