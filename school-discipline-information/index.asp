...
<div id="wrapper">
  ...
  <div id="top-section">
  <h1 id="contentheader">Introduction</h1>
  <div id="bcrumb"> : Intro</div>
  </div>
  <!-- ############################### BEGIN CONTENT #################################### -->
  <h2>Parents of children with disabilities often ask:</h2>
  <ul type="disc">
  ...
  <li>What happens to my child’s educational services if he or she is sent home, suspended, or expelled?</li>
  </ul>
  <p>This interactive guide will answer these and  many other questions. Whether your child is on an <span class="def" id="iep">Individualized Education Program  (IEP)*</span> or a <span class="def" id="504">Section 504 Plan*</span>, or if you suspect that your child has a disability  that affects his or her behavior at school, this guide will help you understand  the complex disciplinary process for Minnesota public school children with  disabilities.</p>
  <p><a class="buttonLink" href="/school-discipline-information/02-iep-504.asp">Begin &gt;&gt;&gt;</a></p>


	<div class="def-list"><a href="/school-discipline-information/definitions-list.asp">* - definition</a></div>
  <!-- ############################### END CONTENT #################################### -->
  <!--Close Discipline Content--></div>
