    ...
    <div id="maincontent">
      <div id="pagetoporange">
        ...
        <div id="breadcrumb"> <a href="/">Home</a> / <a href="../events.asp">Events</a> / <a href="/help/symposium/">Mann Symposium</a>
          <h1>Ninth Annual PACER Symposium about Children &amp; Young Adults with Mental Health &amp; Learning Disabilities</h1>
        </div>
      </div>
      <!--BEGIN CONTENT-->
      <div id="pagecontent">
      ...
      %> 
      <div id="header-image" style="text-align:center"><img src="/help/symposium/2014/images/symposium-banner.jpg" width="783" height="163" alt="" /></div>
...
believes that changing our responses to students who have behavioral issues is key.
          ...
          <tr>
            ...
            <td style="vertical-align: top; padding: .6em;" width="300">
              ...
              <ul>
              	<li>Controlling  Your Emotions and Behavior Regardless of How Disagreeably Others Treat You<strong></strong></li>
				<li>Scared,  Sad, and Spacey:&nbsp; Handling Emotional Distress in the Classroom<strong></strong></li>
				<li>The  Use of Prone Restraint in School:&nbsp; Minnesota&rsquo;s Experience<strong></strong></li>
				<li>Siblings  Forever:&nbsp; Brothers and Sisters Share Their Stories<strong></strong></li>
				<li>Important  Lessons Learned in Parenting a Child with Disabilities<strong></strong></li>
				<li>Student  Success for $100 or Less:&nbsp; Free and Low-cost Assistive Technology for  Students<strong></strong></li>
				<li>From  Naughty to Nice:&nbsp; The Road to Positive Behavior Interventions</li>
			  <!--
...
%>
<hr />
<div class="greenbordered" id="sponsors">
<h3 class="green">Sponsors</h3>

              <p><strong class="green">Major Sponsor</strong><br />
              	Lenzmeier Family Foundation</p>
              <p><strong class="green">Partner Sponsor</strong><br />
              	Rebecca Wallin And Don Dickinson<br />
              	</p>
              <p><strong class="green">Patron Sponsor</strong><br />
              	Sanford Health</p>
              <p><strong class="green">Friend Sponsor</strong><br />
              	Alkire Family Foundation</p>
