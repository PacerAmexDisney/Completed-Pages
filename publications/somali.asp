...
<title>Publications: Translated Materials-Somali</title>
...
<a href="../translations/somalipubs.asp">See this page in Somali >>></a>
</div>
...
<div id="maincontent">
	...
	<div id="breadcrumb">
	<a href="../index.asp">Home</a> / <a href="../pandr/index.asp">Programs &amp; Resources</a> / <a href="index.asp">Publications</a> / Translated Materials<font face="Arial">&#8213;</font>Somali
...
<h2 class="nounderline"><a name="maincontent">Translated Materials<font face="Arial">&#8213;</font>Somali</a></h2>

<p>
PACER offers bilingual workshops, individual assistance and translated publications focusing on issues facing families from diverse backgrounds. The following publications have been translated into Somali.
</p>

<h3 class="pubcat" style="margin-bottom: .5em;">Interactive</h3>
<div class="description">
  <p><strong>NEW!  Special Education: What Do I Need to Know? (Somali version)</strong> <br />
  ...
  <p><a class="videoPopUp" href="https://www.youtube.com/watch?v=PkkD7tVoVVY">Watch it now<img src="../images/movieReelIcon_small.gif" width="25" height="25" alt="Flash Video " /></a></p>
  This presentation is also available in English, Hmong, and Spanish <a href="http://www.pacer.org/publications/specedrights.asp">learn more  &gt;&gt;&gt;&gt;</a></div>
		<%
		sql = "SELECT * FROM Publications WHERE pub_somali = 'yes' AND pub_type = 'infocard' ORDER BY pub_name"
		...
		<%
		sql = "SELECT * FROM Publications WHERE pub_somali = 'yes' AND pub_type = 'book' ORDER BY pub_name"
		set rs = conn.execute(sql)
...
<img src="../images/pdficon_small.gif" width="15" height="15" alt="pdf icon" /> | $1.50 per request | 10+ copies, $.50 each</span></h3>
		...
		<%
		sql = "SELECT * FROM Publications WHERE pub_somali = 'yes' AND pub_type = 'handout' ORDER BY pub_name"
		set rs = conn.execute(sql)
