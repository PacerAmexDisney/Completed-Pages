...
<!-- ###################### END Navigation ############################## -->
  ...
  <table border="0" width="100%" class="datasetnav fltrt">
  <tr>
  ...
  <a style="font-size:.9em" href="/bullying/about/news-archive.asp?year=<%=DatePart("yyyy", Now()) - 1%>">Go To News Archives</a>
  </p>
  </div>



    <h1 id="maincontent">In The News</h1>            
...
<div style="text-align:right; width:290px; margin:10px auto; padding-top:5px; clear:right">
  <a style="font-size:.9em" href="/bullying/about/news-archive.asp?year=<%=DatePart("yyyy", Now()) - 1%>">Go To News Archives</a>
  </div>
<br class="clearfloat" />
  <!-- end .content --></div>
