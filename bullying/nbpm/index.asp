  ...
  <h2 id="Top10">Top 10 reasons to celebrate</h2>
    <div class="flex" id="Row1">
     <aside class="flexItemThumb">
      <img width="160" height="160" src="/bullying/getinvolved/images/topTen_thumb.jpg" alt="" />
     </aside>
...
<%'----------------------------------- END TOP TEN LIST -------------------------------------- %>   
    ...
    <ul>
      ...
      <h2>Unity Day 2017, Oct. 25! Wear and Share Orange!</h2>
            <div class="flex" id="Row1">
        <aside class="flexItemThumb">
          <img src="/bullying/nbpm/images/ud-crowns-160px.jpg" width="160" height="159" alt=""/>
        </aside>
        <article class="flexItemDescription">
               <p><strong>Together against bullying &mdash; united for kindness, acceptance and inclusion.</strong></p>
    ...
    <div class="flex" id="Row1">
       <aside class="flexItemThumb">
        <img src="/bullying/nbpm/images/nbpm-sml-RWR-2011-09.jpg" alt="" height="150" width="150">
       </aside>
       <article class="flexItemDescription">
          <h3><a href="/bullying/nbpm/runwalkroll/events-around-the-country.asp">Run, Walk, Roll Against Bullying</a></h3>
          <p>A family-friendly  event held by schools, businesses or communities to show the nation&rsquo;s  commitment to keeping students safe while at school, in the community, and  on-line. The event can be accompanied by pre-and post- activities such as games  for kids, speakers, music, prizes and dance.</p>
        </article>
    </div> 
    ...
    <div class="flex" id="Row1">
       <aside class="flexItemThumb">
        <img src="/bullying/nbpm/images/nbpm-sml-Bg-YNA.jpg" alt="" height="150" width="150">
       </aside>
       <article class="flexItemDescription">
          <p><a href="http://www.pacer.org/bullying/yourenotalone/event-toolkit.asp"><strong>Order the "You're Not Alone, We're Here for You"</strong></a> event toolkit designed to help you hold an awareness raising event to unite against bullying and unite together to provide community, support, and hope for those who have experienced bullying. The toolkit can be used in coordination with a bullying prevention event in the school or community, such as a "Run, Walk, Roll Against Bullying," school open house, or parent teacher conferences.</p>
        </article>
    </div>     
    ...
    <h2>Other Exciting Opportunities</h2>
      <div class="flex" id="Row1">
        <aside class="flexItemThumb">
          <img src="/bullying/nbpm/images/nbpm-sml-Bg-weWill1.jpg" alt="" height="150" width="150">
        </aside>
        <article class="flexItemDescription">
          <h3><strong>Involve Students</strong></h3><p><a href="/bullying/wewillgen/"><strong>The  WE WILL Generation</strong></a> is a program designed to inspire student to student engagement to lead the bullying prevention movement! Students say, &ldquo;<em>We will be the generation that  says, &lsquo;This is our issue and we will be the solution</em>.&rsquo;&rdquo; &nbsp;The program includes education on what students can do to help someone being bullied, ideas for connecting older  students with younger students, and a student taught curriculum.</p>
        </article>
      </div> 

      <div class="flex" id="Row1">
        <aside class="flexItemThumb">
          <img src="/bullying/nbpm/images/nbpm-sml-Bg-connect.jpg" alt="" height="150" width="150">
          <img class="desktopThumb" style="margin-top: 20px" width="160" height="161" src="/bullying/nbpm/images/nbpm-sml-kab-poster.jpg" alt="" />
          <img class="desktopThumb" style="margin-top: 20px" width="160" height="160" src="/bullying/nbpm/images/nbpm-sml-above-the-line-image.png" alt="" />
        </aside>
        <article class="flexItemDescription">
          <h3><a href="/bullying/resources/activities/">Educational Activities</a></h3>
