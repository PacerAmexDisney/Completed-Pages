...
if  InStr(supporteractionrequest, "Approve") > 0 then
	SQLupd = "UPDATE icarebecause SET bullysupport_online = '" & supporteractionrequest & "', bullysupport_approvaldate = '" & date & "' WHERE bullysupport_ID = " & supporterid & ";"
elseif supporteractionrequest = "Disapprove" then
	SQLupd = "UPDATE icarebecause SET bullysupport_online = 'Disapprove' WHERE bullysupport_ID = " & supporterid & ";"
else
