...
<table id="itemList" align="center" cellspacing="10">
<% 
...
<tr>
        ...
        <td width="210" valign="top">
            <input name="Approvednokid_<%=ICareRecordSet("bullysupport_ID")%>" type="button" value="Approved But Not On KAB" onclick="SubmitForm('Approve-NoKids', <%=ICareRecordSet("bullysupport_ID")%>);" /><br /><br />
            <input name="Approved_<%=ICareRecordSet("bullysupport_ID")%>" type="button" value="Approved For All Sites" onclick="SubmitForm('Approve', <%=ICareRecordSet("bullysupport_ID")%>);" /><br /><br />
            <input name="Approved_kidonly<%=ICareRecordSet("bullysupport_ID")%>" type="button" value="Approved KAB Only" onclick="SubmitForm('Approve-KidsOnly', <%=ICareRecordSet("bullysupport_ID")%>);" /><br /><br />
