...
<a id="skiptocontent" href="#maincontent">Skip to main content</a>
  ...
  <div class="sidebar1"> 
	...
	var currId="studentactivities-turning180";	
...
document.getElementById(currId).className = "active";
  ...
  <div class="content"> 
	...
	<h2><strong>Practice Turning a 180</strong></h2>
	<p>Goal: Encourage students to practice redirecting negative situations to a more positive direction. </p>
<div class="materials">
  <h3>Materials: </h3>
    <ul>
      <li>Examples of bullying situations</li>
    </ul>
</div>
    <h3>Directions:</h3>
        <ol>
          ...
          <li>Instruct groups to come up with at least four ways they could &ldquo;turn a 180&rdquo; on their chosen situation. Encourage them to focus on ways to show support for the target, but their solutions may also include ways to respond to the person bullying (see examples in TRUCE video).<br />
        For example:
        <ul type="disc">
