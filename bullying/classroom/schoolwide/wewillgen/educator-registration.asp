  ...
  <div class="breadcrumb"> <a href="/bullying/">Home</a> / <a href="/bullying/wewillgen/">We Will Generation</a> /</div>
	...
	<div class="content">
		...
		<div class="singlecolumn">
			<h2 id="maincontent">WE WILL Generation &ldquo;Student-to-Student&rdquo; Curriculum</h2>
<p>Register to access the free on-line, student-to-student curriculum designed for middle and high school student leaders to engage, educate and inspire younger students to be a part of The We Will Generation. Registrants are asked to:</p>
<ul>
<li>Recruit students for the role of trainers.</li>
<li>Work with an adult advisor to determine the group(s) that will receive the training.</li>
<li>Present all lessons in the curriculum, but aren&rsquo;t required to do all sections within each lesson.</li>
