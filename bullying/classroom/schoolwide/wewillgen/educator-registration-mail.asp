...
<script type="text/javascript">
	...
	<div class="content">
		...
		<div class="singlecolumn">
			<h1 id="maincontent">WE WILL Generation &ldquo;Student-to-Student&rdquo; Curriculum </h1>
			<%=msg%>
			<% If Not errorFlag Then%>
			<p>Thank you for registering for PACER&rsquo;s WE WILL Generation Curriculum.</p>
			<p>Next  steps: </p>
			<ol>
				<li> Recruit  the student trainers </li>
				<li>Determine  the students that will receive the training </li>
				<li>Review  the curriculum </li>
				<li>Introduce  the lessons to the student trainers </li>
				<li>Encourage  the student trainers to review the lessons </li>
			</ol>
