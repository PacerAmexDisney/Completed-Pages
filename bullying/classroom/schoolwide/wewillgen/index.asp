...
#wwghashtagdata { margin-top: 25px; }
...
<div id="wewill-1" class="content"> <a href="#" id="wewill-1a" class="contentrow-anchor" aria-hidden="true"></a>
	<div id="topheroimage"> <img src="/bullying/wewillgen/images/hero-gradient.jpg" width="1024" height="371" alt=""/>
		<h1 style="font-size:30px">Join the<br />
			<span style="font-size:48px">We Will Generation<span style="font-size:25px; position:relative; top:-20px;">&trade;</span></span><br />
			<span style="font-size:20px; text-shadow:1px 1px 2px #000; line-height:22px;">Resources designed to encourage student to student <br />conversation to educate, inspire and support peers to <br />create kinder and safer schools</span></h1>
	...
	<div class="addthis_sharing_toolbox"></div><div class="sharethis" style="float:right; width:3em;">Share:</div>
		...
		<h2 style="font-size:48px; line-height:52px; text-shadow: 0px 0px 5px #000; margin-bottom:10px">Nearly 60%<br />
			...
			<p>A powerful statistic, showing the important influence that peers can have.  Imagine the power of student-to-student engagement in which students are educated, inspired, and supported to take positive action to help their peers.</p>
			<p>The WE WILL Generation is the generation of students that believes:</p> 
			<ul>
				<li>	bullying is never an acceptable behavior</li>
				<li>	everyone deserves to be safe</li> 
			...
			<p>The WE WILL Generation is about empowering students to take action and be a part of creating safe and supportive schools. The resources of the program are designed to be used in schools to encourage student to student —typically older students talking with younger students— conversation and education around creating a culture that is together against bullying—and united for kindness, inclusion and acceptance.</p>

			<p><strong>Why is student to student engagement important?</strong></p>
			<ul>
			...
			<li>To be successful they need a school-based structure, supported with resources that provide practical strategies, solid information, and action steps.</li>
			...
			<p>The WE WILL Generation includes the following resources for students (and adults) to create safe and supportive school environments:
				<ol>
					<li>Ideas for students on how to <a href="#reachout-2a">REACH OUT</a> and be supportive of peers</li>
					<li>Resources that provide creative ways to <a href="#speakup-3a">SPEAK UP</a> and initiative conversation</li>
					<li>Curricula designed for student leaders to <a href="#curricula-4a">EDUCATE</a> themselves and other students about the dynamics of bullying and the important role students have in intervention and prevention.</li>
				</ol>	
	...
	<div id="curricula-4" class="contentrow row-whiteorange spyitem"> <a href="#" id="curricula-4a" class="contentrow-anchor" aria-hidden="true"></a>
		...
		<table class="threecoltable">
			<tr>
				...
				<td><p>Are you an educator—or a student—looking for an opportunity to build student leadership, to help develop advocacy skills and provide education on methods to respond to bullying? The WE WILL Generation curriculum is your answer. A free on-line, curriculum designed for student leaders to engage, educate and inspire other students to be a part of The We Will Generation. To sign up for this opportunity, complete the registration form, and follow the instructions to access the lessons, activities, video, and other resources. </p></td>
	...
	<div id="bottomContentWrapper">
		<div class="leftBox bottomContent" id="fbfeed">
			<div id="fbfeedheader" class="centered"><a href="https://www.facebook.com/PACERsWEWILLGeneration"><img class="fltlft" src="/images/facebookicon_medium.gif" alt="" width="35" height="35" /> Join the WE WILL Generation Facebook Page</a></div>
			<div id="fbfeeddata">
				<p>Loading...</p>
			</div>
		</div>
		<script type="text/javascript">
$('#fbfeeddata').load('/bullying/wewillgen/fbfeed.php');
</script>
		<div class="rightBox bottomContent" id="hashtag-feed">
			<div id="wwghashtagheader"> <a href="https://instagram.com/wewillgen/" target="_blank"><img src="/images/instagramicon_medium.png" alt="Follow the WeWillGen on Instagram" width="35" height="35" class="fltlft" title="Join the WeWillGeneration on Instagram" /></a> <a href="https://twitter.com/search?q=%23WeWillGen&src=hash&f=realtime" target="_blank"><img src="/images/twittericon_medium.png" alt="" width="35" height="35" class="fltrt" title="Join Us at #WeWillGen" /></a>
				<h2>#WeWillGen</h2>
				<div id="wwgtwitterhandle"><a href="https://twitter.com/wewillgen" title="Follow us on Twitter @WeWillGen" target="_blank">@WeWillGen</a></div>
				<div id="wwginstagramhandle"><a href="https://instagram.com/wewillgen/" title="Follow us on Instagram @WeWillGen" target="_blank">@WeWillGen</a></div>
			</div>
			<div id="wwghashtagdata">
				<p>Loading ...</p>
			</div>
			<!-- close hashtag-feed --> 
		</div>
		<script type="text/javascript">
$('#wwghashtagdata').load('/bullying/wewillgen/hashtagfeed.php');
</script> 
	...
	<div id="nbpc-7" class="contentrow row-whiteorange spyitem">
		...
		<img src="/bullying/wewillgen/images/weWillGen.jpg" style="display:block; margin-left:auto; margin-right:auto; padding-bottom:20px" width="346" height="159" alt=""/>
		<div class="singlecolumn">
			<p>The WE WILL GENERATION was designed for schools and other organizations to leverage resources, at no cost and easily accessible on-line, to encourage student to student conversation to educate, inspire and support peers to address bullying and create kinder and safer schools.</p> 
			<p>Students are ready to take a significant role in the bullying prevention movement. “We will be the generation that says, ‘This is our issue and we will be the solution.’” Bullying is an issue that directly impacts children and youth every day. Today’s generation of students is ready to take action and uniquely positioned to prevent and stop bullying. What they need is education, support, and inspiration – and a creative program that will give them the practical skills to be part of the solution. The WE WILL Generation is an exciting new initiative developed by PACER’s National Bullying Prevention Center that uses a students talking with students model to build leadership and encourage a change in culture to address bullying.</p>
		</div>
		<div class="centered">
