  ...
  <%'---------------------------- END LAYER SLIDER ------------------------------------%>
	...
	<div id="secondarynav" style="border-top:solid 1px #ccc" class="whitenav" role="navigation"> <a href="/bullying/"><img id="navlogo" src="/bullying/images/styles/navLogo.png" width="40" height="40" alt="NBPC Homepage" /></a>
		<ul class="justifiedlist">
			<li id="spynav-1"><a href="#youre-not-alone">PACER's You're Not Alone</a></li>
			<li class="dash"></li>
...
<div id="stand-together" class="contentrow row-orange row-shadow" style="height: 265px"> <a href="#" id="stand-together" class="contentrow-anchor" aria-hidden="true"></a>			
	<div class="addthis_sharing_toolbox"></div><div class="sharethis" style="float:right; width:3em;">Share:</div>
		...
		<div class="singlecolumn" style="clear:right">
			...
			<p>You&rsquo;re Not Alone gives students, adults and communities ideas how they can help so that</p>
			<ul>
...
<div id="toolkits" class="contentrow row-white red spyitem"> <a href="#" id="toolkits" class="contentrow-anchor" aria-hidden="true"></a>	
	<div class="singlecolumn">
		...
		<p>Create communities that send the message to students who are bullied that they are not alone!<br />
			Educate students, adults and community members that support, kindness and hope is something everyone can give!</p>		
		<div class="inrow-button" style="float:right;">
		<a href="/bullying/yourenotalone/event-toolkit.asp">Hold an Event</a>	
		<p align="center">Resources for holding a public event at school or in the community with posters, petition, handouts, and give-aways. $75.00 per toolkit.</p>
<p>&nbsp;</p>
		</div>
		<div class="inrow-button">
		<a href="/bullying/yourenotalone/classroom-toolkit.asp">Classroom Activities</a>
		<p align="center">Opportunities for meaningful conversation, visual reminders, and participation incentives. Include posters, discussion guides, educational handout and stickers. $50.00 per toolkit.</p>
<p>&nbsp;</p>
		</div>
