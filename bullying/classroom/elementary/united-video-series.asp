...
<div class="contentrow row-purple row-shadow">
	...
	<h2 style="font-size:30px; line-height: 40px">Animated Video Series for <br />Elementary School Students</h2>	
	<p>This simple, authentic animated video series was created from student drawings and writing, which poignantly provides insight into how painful bullying can feel, but also touchingly shows that kids want it to stop and want to be part of the solution. </p>
	<p>The series of videos creatively illustrates what it feels like to be bullied, what students can do if they see bullying, and how to be an advocate against bullying. Watch each video, then hold a classroom discussion using the suggested questions.</p>
