...
document.getElementById(currId).className = "active";
 ...
 <div class="content"> 
  <h1 id="maincontent" style="text-align:center"><img src="/bullying/images/partners/spookley-banner.jpg" width="549" height="141" alt="Spookley the square pumpkin" /><br />
   ...
   <strong><span style="font-size:.8em">Complete Digital Teacher Toolkit (pre-school, K-3) to accompany<br /><em>The Legend of Spookley the Square Pumpkin</em></span></strong></h1>
  
  <!--
  <p style="font-weight:bold; font-style:italic;"><img style="float:right; margin-left:10px; margin-right:0px; padding-right:0px" src="/bullying/resources/toolkits/spookley/images/Spookley-Cover.jpg" width="253" height="253" alt="" />To supplement the reading of The Legend of Spookley the Square Pumpkin book, the Spookley movie screenings are being offered to educators for free through October in Celebration of National Bullying Prevention Month!</p>
  -->
  
  
  
  
  <div id="spookley-items" class="alertBox" style="width:240px; clear:right">
   <h3>Educators:<a href="http://www.surveymonkey.com/s/NDTHJMY"><img src="/bullying/resources/toolkits/spookley/images/registerHere.png" width="215" height="75" alt="Register Here" /></a></h3>
<p class="centered"><a href="http://www.surveymonkey.com/s/NDTHJMY">Register Here to Get Access to all of the Toolkit Materials</a></p>
 ...
 <li>Video Reading of A Family to be Thankful For.</li>
  ...
  <!--<div id="spookley-tshirt" class="alertBox" style="width:240px; clear:right">
 ...
 <img style="margin-left:10px;" src="/bullying/images/partners/spookley-sml.jpg" width="119" height="71" alt="" />
  ...
  <p>This online toolkit includes resources educators can use to effectively present <em>The Legend of Spookley the Square Pumpkin</em> as a multi-subject learning opportunity. The core elements of the online toolkit involve a reading of the book supplemented by downloadable lesson plans and other activities that teach bullying prevention and character values. Teachers can enhance the experience by:</p>
   <ol>
   <li>Putting on the Spookley Classroom Play</li>
   <li>Watching the movie
    <ul>
     <li><em>Online streaming of the movie is FREE for educators <br />
     throughout October as part of National Bullying Prevention Month!</em> </li>
     <%'<li><strong><em>Free Video Streaming Extended Through November</em></strong></li>%>
    </ul>
   </li>
