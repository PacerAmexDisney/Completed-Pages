...
<div class="content">
<h1 id="maincontent" style="margin-bottom:0px; padding-bottom:0px;">Videos</h1>
...
%>    
		<div class="videocontainer">
  			<div class="imagewrapper">
  				<a href="/bullying/video/player.asp?video=<%=rsFeatured("video_ID")%>" title="<%=RemoveQuotes(rsFeatured("title"))%>" aria-hidden="true">
            	<img src="<%=rsFeatured("imageURL")%>" width="150" alt="<%=RemoveQuotes(rsFeatured("title"))%>" /></a>
            </div>
...
%>    
		<div class="videocontainer">
  			<div class="imagewrapper">
  				<a href="/bullying/video/player.asp?video=<%=rsPopular("video_ID")%>" title="<%=RemoveQuotes(rsPopular("title"))%>" aria-hidden="true">
            	<img src="<%=rsPopular("imageURL")%>" width="150" alt="<%=RemoveQuotes(rsPopular("title"))%>" /></a>
            </div>
...
%>
<tr>
<td aria-hidden="true"><a href="/bullying/video/player.asp?video=<%=rsAll("video_ID")%>"><img src="<%=rsAll("imageURL")%>" width="150" alt="<%=RemoveQuotes(rsAll("title"))%>" /></a></td>
