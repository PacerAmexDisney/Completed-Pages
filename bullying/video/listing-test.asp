...
video_cmd.CommandText = "SELECT * FROM bullyVideos WHERE pageName = '" & Request.QueryString("category") & "' AND visible <> 'false' ORDER BY title;" 
...
<%Else%>
	...
	<h1 id="maincontent"><%=video.Fields.Item("pageName").Value%> Videos</h1>
...
%>		
        ...
        <%=video.Fields.Item("additionalHTML").Value%>
