...
<div class="content">
    ...
    <h1 id="maincontent">What Parents Should Know About Bullying</h1>
       ...
       <div id="toolMainBanner">
        ...
        <div id="toolDescription">
          ...
          <div id="descriptionWrap">
            ...
            <p>Bullying can be an isolating experience &mdash; not just for the kids involved &mdash; but for their parents, too. Fortunately, there is help. This guide  offers a comprehensive overview&nbsp;for parents to learn what they can do to  address and prevent bullying.</p>
          </div>
      ...
      <div class="contentrow row-orange row-shadow" id="intromessage">
        ...
        <h2 style="clear:right;">Getting Started</h2>
        <p class="singlecolumn">If your child is being bullied, has witnessed bullying, or is  showing bullying behavior, you may be wondering what you can do to help. This  information is designed to&nbsp;help you&nbsp;understand the dynamics of  bullying so that you can develop&nbsp;a&nbsp;strategy that best fits your  child&rsquo;s situation.</p>
      </div>
      <p style="text-align:center; padding-top:30px;"><a class="btn btn-cta" href="/bullying/resources/parents/definition-impact-roles.asp">Continue</a></p>
