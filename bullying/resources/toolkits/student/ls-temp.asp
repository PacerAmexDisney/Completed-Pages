...
<div id="layerslider" class="loading">
	...
	<div id="terryVid" class="ls-layer">
        <div class="ls-s1" style="background:#333; width:637px; height:375px; text-align:center;">
			<img src="/bullying/resources/toolkits/student/images/Jetset-saturdaynight-cover.jpg" width="375" height="375" style="display:block; margin:0px auto" />        
        </div>
    </div>
...
<div class="bio noShow" id="paulBio">
	...
	<p><img width="349" height="591" class="fltrt" src="/bullying/resources/toolkits/student/images/Jetset_PaulKelley_250w.jpg" alt="" style="background:#F63;" />
