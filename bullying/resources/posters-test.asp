...
closeDate = DateAdd("d", -14, cDate("10-21-2016 7:00 AM"))

nextYear = DatePart("yyyy", closeDate) + 1

SoldOutEnglish = False
SoldOutSpanish = False
SoldOutEnglish10pk = False
SoldOutSpanish10pk = False
...
<a id="skiptocontent" href="#maincontent">Skip to main content</a>
  ...
  <div class="content"> 
    ...
    Unity Day Posters 
      ...
      <%End If%>
    <%Else%>
    Orders for <%=nextYear%> Unity Poster to open this summer!
    <%End If%>
    </h1>
...
<%If Not (SoldOutEnglish10pk And SoldOutSpanish10pk And True) Then
'Remove Per Front Office not wanting this messaging on there.
%>
<tr>
<td colspan="3" align="center">
<p><strong>For larger quantities or combinations of 10pk&rsquo;s please call 952.838.9000</strong></p>
</td>
</tr>
<%End If%>
...
<div style="font-size:1.4em; font-weight:bold; text-align:center; margin:50px;">Orders will open summer <%=nextYear%>.</div>
