...
<title>National Bullying Prevention Center - Student Action - University of Minnesota students launch bullying prevention campaign with Maple Grove Junior High</title>
...
<!--#include virtual="/bullying/topnav.html"-->
  ...
  <div class="content">
    ...
    <h2>University of Minnesota students launch <br />bullying prevention campaign with Maple Grove Junior High </h2>
</td></tr>
<tr>
<td valign="top">
    <p>The University of Minnesota Bateman Team, partnered up with Maple Grove Junior High this month to promote kindness in their school. The campaign began as a national public relations campaign competition through the Public Relations Student Society of America (PRSSA), but it quickly became much more than that. </p>
    <p>Starting in November 2012, the team began working to create Together, For Good, a month-long campaign with the goal of spreading kindness as a way to end bullying. We chose to go with a positive approach and instead of telling students what&nbsp;<em>not</em>&nbsp;to do, we encourage students to build healthy relationships with their peers.&nbsp;One way the team has done this is by creating the MGJH Nice Box where students can nominate peers who are seen demonstrating what it means to be &lsquo;Maple Grove Nice.&rdquo; Four winners are drawn each week and a majority of the nomination comments are posted through @MGJH_NiceThings. </p>
    <p>The main piece of their campaign is The Chain Project, a physical representation of the community joining together to make a change. The message of the chain is that while one person can speak out against bullying, we are much stronger when we come together to make a difference. This chain will include student responses to bullying, as well as those of community members.</p>
