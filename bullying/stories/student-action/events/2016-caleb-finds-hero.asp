...
<title>National Bullying Prevention Center - Student Action - He Finds the Hero in Himself</title>
<meta property="og:title" content="National Bullying Prevention Center - Student Action - He Finds the Hero in Himself" />
...
<div class="container">
    ...
    <div class="content">
        <div class="narrowContent">
            <h1 id="maincontent">He Finds the Hero in Himself</h1>
            <table width="100%">
                <tr>
                    <td valign="top">
                        ...
                        <p>It is Caleb’s goal to expand this student-led program to all public schools in Portland, Oregon, and to other schools nationwide!</p>
                    </td>
                    <td id="sidebar" width="320" style="text-align:center; padding:0 20px 10px 20px;" valign="top">
                        <p><img src="/bullying/stories/student-action/events/images/caleb-front.jpg" width="320" height="492" alt=""/></p>
                    </td>
                </tr>
            </table>
        </div>
