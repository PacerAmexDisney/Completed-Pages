...
rs_cmd.CommandText = "SELECT * FROM dbo.bullyStories WHERE category='Donation' ORDER BY date_added DESC" 
...
<title>National Bullying Prevention Center - Get Involved - Inspired Fundraising Stories</title>
...
<!--#include virtual="/bullying/topnav.html"-->
 ...
 <div class="content">
  ...
  <tr>
  <td align="center" colspan="4">Page <%=cInt(rs_last / RecordsPerPage)%> of <%=RoundUp(rs_total / RecordsPerPage)%>
	</td></tr>
    <tr>
    ...
    <h1 id="maincontent">Inspired Fundraising</h1>
    <div id="storyitems">
    	<% 
 Dim flashCount
 flashCount = 1
...
<table border="0" class="datasetnav" style="margin:10px auto; clear:left">
  <tr><td colspan="4" align="center">Page <%=cInt(rs_last / RecordsPerPage)%> of <%=RoundUp(rs_total / RecordsPerPage)%>
</td></tr>
<tr>
    <td><% If MM_offset <> 0 Then %>
        <a href="<%=Replace(MM_moveFirst, "&", "&amp;")%>">First</a>
