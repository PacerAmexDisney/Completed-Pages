...
<!--	<div class="downloadbox">
 ...
 -->
	...
	<p>The WE WILL Generation is a student-centered movement, with two options for presenters:</p>
    <ol type="a">
	  <li>educator in the classroom or other adults such as guidance counselor, coach or mentors</li>
      <li>adult advisors that train students as presenters</li>
    </ol>
<h2>Advisor Role</h2>
    <p>For those who decide to train student presenters, having an adult advisor is important to the students&rsquo; success. The advisor could be a teacher, guidance counselor, social worker, or administrator. Other potential advisors include coaches, mentors, community leaders and volunteers.</p>
    ...
    <p>The information on this page is designed as guide for adult advisors when setting up logistics. </p>
