...
<!--	<div class="downloadbox">
 ...
 -->
	...
	<p><strong>What are the resources of &ldquo;The WE WILL Generation&rdquo;?</strong></p>
    <ol>
      <li>Ideas for students &ndash;and adults- on how to <a href="http://www.pacer.org/bullying/wewillgen/#reachout-2a"><strong>REACH OUT</strong></a> and be supportive of peers</li>
      <li>Resources that provide creative ways to <a href="http://www.pacer.org/bullying/wewillgen/#speakup-3a"><strong>SPEAK UP</strong></a> and initiate conversation</li>
      <li>Curricula designed to <a href="http://www.pacer.org/bullying/wewillgen/#curricula-4a"><strong>EDUCATE</strong></a> students about the dynamics of bullying and the important role students have in intervention and prevention. Presenters can be:
      <ol type="a">
      <li>educator in the classroom, or </li>
...
<p><strong>Who presents the WE WILL Curriculum?</strong><br />
  The curriculum is designed to be presented by (a) an educator to share in the classroom (b) adult advisor to train student leaders who then present to other students. </p>
<p><strong>Can other adults present the WE WILL Curriculum?</strong><br />
Yes! The curriculum can easily be adapted for use by a teacher, group leader, coach, or other adult.</p>
<p><strong>If training students, how many student presenters should be involved?</strong><br />
...
<p><strong>What is the goal of the WE WILL Curriculum?</strong><br />
    ...
    No, the WE WILL Curriculum can be adapted for the needs of the group.</p>
