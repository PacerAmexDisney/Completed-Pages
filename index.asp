...
<li><img style="width: 100%; height: auto;" src="/stc/images/SpecialNeeds-FBGroup-Banner.jpg" alt="" />
					...
					<%If DateDiff("n", Now, cDate("9-23-2017 2:00 PM")) > 0 Then %>
					<li>
						<h3>Join Us &mdash; Family Fun Day &amp; Tech Expo!</h3>
						<p><img class="fltrt" src="/images/homenews-sml/stc-superhero.png" width="141" height="140" alt=""/> <strong>Saturday, Sept. 23<sup>rd</sup></strong><br />
							10 a.m. to 2 p.m.</p>
						<ul>
						...
						<p><a href="http://www.pacer.org/forms/workshops.asp?wksp=67768C8B-CAE1-413F-841A-3E4447EDC144">Advanced Registration is Required - Sign Up Now.</a></p>
					</li>
					<%End If%>
