...
If request.Form("submit")="Submit Form" And Not IsBot Then
	...
	content = content & "Please describe your student/child’s disability and how it affects them academically and socially:" & vbCrLf
	content = content & request.form("childDisability") & vbCrLf & vbCrLf
	content = content & "Please describe your student/child's strengths:" & vbCrLf
	...
	content = content & "Does the student/child use a computer at school? - " & request.form("childComputerUse") & vbCrLf & vbCrLf
	content = content & "Do you currently us AT with the student/child? - " & request.form("childATUse") & vbCrLf & vbCrLf
	content = content & "What AT does the student/child currently use and do you find it helpful?" & vbCrLf
	content = content & request.form("whatAT") & vbCrLf & vbCrLf
	content = content & "What skill areas would you like your student/child to develop or improve with assistive technology?" & vbCrLf
	content = content & request.form("otherAT") & vbCrLf & vbCrLf
	content = content & "Why do you wish to participate in Project KITE?" & vbCrLf
...
<a href="/index.asp">Home</a> / <a href="/pandr/index.asp">Programs &amp; Resources</a> / 
	<a href="../index.asp">Simon Technology Center</a> / <a href="index.asp">Project KITE</a> /
