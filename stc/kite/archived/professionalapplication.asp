...
<img src="../../css/printicon.gif" width="15" height="14" alt="" /><a href="javascript:window.print()">Print page</a>
	...
	<a href="../../index.asp">Home</a> / <a href="../../pandr/index.asp">Programs &amp; Resources</a> / <a href="../index.asp">Simon Technology Center</a> / <a href="index.asp">Project KITE</a> / Teacher/Service Provider Participation Form
...
<h2 class="nounderline"><a name="maincontent">Teacher/Service Provider Participation Form</a></h2>
<p>
...
<form action="professionalSubmit.asp" method="post">
<table>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="date" size="40" id="date" /></td>
	</tr>
	<tr>
		<td class="title"><label for="schoolname">School/facility name:</label></td>
		<td><input type="text" name="schoolName" id="schoolname" size="40" /></td>
	</tr>
	<tr>
		<td class="title"><label for="title">Title:</label></td>
		<td><input type="text" name="title" size="40" id="title" /></td>
	</tr>
	<tr>
		<td class="title"><label for="studentname">Student's Name:</label></td>
	...
	<tr>
		...
		<td><input type="text" name="grade" size="40" id="grade" /></td>
	</tr>
</table><br />
<label for="childdisability">Please describe the child's disability:</label><br />
<textarea name="childDisability" id="childdisability" rows="5" cols="50"></textarea><br /><br />
<label for="childstrengths">Please describe the child's strengths:</label><br />
...
<ol type="1">
	<li>Tell us about your computer skills.
		<ul class="nobullet">
			...
			<li><label for="computersused">What type of computer(s) have you used</label>?<br /><input type="text" name="computersUsed" size="40" id="computersused" /></li>
			<li><label for="softwareused">What software programs have you used?</label><br /><input type="text" name="softwareUsed" size="40" id="softwareused" /></li>
	...
	<li>Please tell us about the children with whom you work.<br /><br />
		<label for="workwith">How many children with disabilities do you work with on a weekly basis and what are their disabilities?</label><br />
		<textarea name="workWith" id="workwith" rows="5" cols="50"></textarea>
		<ul class="nobullet">
			<li>What are the ages of the children you work with?
			<ul class="nobullet">
				<li><input type="radio" name="ageOfChildren" id="zeroone" value="0-1" /><label for="zeroone">0-1</label></li>
				<li><input type="radio" name="ageOfChildren" id="twothree" value="2-3" /><label for="twothree">2-3</label></li>
				<li><input type="radio" name="ageOfChildren" id="foursix" value="4-6" /><label for="foursix">4-6</label></li>
				<li><input type="radio" name="ageOfChildren" id="sixeight" value="6-8" /><label for="sixeight">6-8</label></li>
				<li><input type="radio" name="ageOfChildren" id="otherage" value="Other" /><label for="otherage">Other</label> <input type="text" name="ageOfChildrenOther" size="20" /></li>
			</ul></li>
			<li>Do you work with children from the following cultural backgrounds?
			<ul class="nobullet">
			...
			<li>Which income groups represent the children you work with?
			<ul class="nobullet">
			...
			<li>In which geographical areas do the children you work with live?
			<ul class="nobullet">
	...
	<li>Would you be a potential resource person for others?
		<ul class="nobullet">
			...
			<li><input type="checkbox" name="resource" id="otherkite" value="Another KITE Team" /> <label for="otherkite">Another KITE Team?</label></li>
		</ul></li>
	<li><label for="wishtoattend">Please write a few lines about why you wish to attend this training and the skills you hope to acquire through Project KITE.</label><br />
		<textarea name="wishToAttend" id="wishtoattend" rows="5" cols="50"></textarea></li>
</ol>
<p>
