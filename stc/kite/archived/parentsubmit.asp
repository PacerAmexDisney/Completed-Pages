...
if request.form("submit")="Submit" then
	...
	content = content & "Child's name:" & request.form("childName") & vbCrLf & vbCrLf
	content = content & "Date of birth:" & request.form("dob") & vbCrLf & vbCrLf
	content = content & "Child's teacher:" & request.form("childTeacher") & vbCrLf & vbCrLf
	content = content & "Grade/Year in School:" & request.form("grade") & vbCrLf & vbCrLf
	content = content & "School Name and City:" & request.form("school") & vbCrLf & vbCrLf
	...
	content = content & "What type of computer do you have access to:" & vbCrLf & vbCrLf
	...
	content = content & "Please describe AT devices or software that you wish to learn more about in Project KITE trainings:" & vbCrLf
	content = content & request.form("atDevicesToLearn") & vbCrLf & vbCrLf
	content = content & "Please tell us about your background." & vbCrLf
	content = content & "What is your cultural background? " & request.form("culturalBackground") & vbCrLf
	content = content & request.form("culturalBackgroundOther") & vbCrLf & vbCrLf
	...
	content = content & "Please write a few lines about why you wish to attend this training and the skills you hope to acquire through Project KITE." & vbCrLf
	...
	content = content & "E-mail (w) " & request.form("wEmail")
