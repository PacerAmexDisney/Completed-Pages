...
<div id="mainbuttons"> 
  ...
  <div id="exploring-btn" class="btn-wrap">
    ...
    <div class="btn-description" id="training-desc">
        ...
        <p>Some technology can be expensive and sometimes there are a  lot of technology options to sort through.&nbsp;  Having access to technology to try helps educators and parents make wise  purchasing decisions and write appropriate technology into an IFSP or IEP.&nbsp; The TIKES project is providing guidance  around establishing policies and procedures as well as inventory to partner  schools.&nbsp; Participants in the project  also receive a free membership to <a href="/stc/library/">PACER Center&rsquo;s Simon Technology Center Technology Library</a> for the duration of the project</p>
  	</div>
  </div>
<div id="school-btn" class="btn-wrap">
    ...
    <div class="btn-description" id="training-desc">
        ...
        <p>The consideration of assistive technology is part of the process of developing an Individual Family Service Plan (IFSP) for children ages birth to 3 and developing an Individualized Education Program (IEP) for children ages 3 to 5.  Whether through a lack of documentation or a lack of knowledge and awareness, not all providers appropriately consider assistive technology.  Many providers are using assistive technology, but they do not always document it as assistive technology. This lack of awareness about the full range and scope of assistive technology often leads to statements in IFSPs and IEPs that there is no need for assistive technology when in fact it is written throughout the document.  TIKES strives to help parents and educators understand the legal process around assistive technology, called the consideration of assistive technology, and how to properly include it and document it in the IFSP and IEP.</p>
    </div>
  </div>
