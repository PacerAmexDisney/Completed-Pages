...
<h1>TIKES - Technology to Improve Kids&rsquo; Educational Success</h1>
  ...
  <div id="maincontent">
   <div id="pagecontent">
        ...
        <!--BEGIN CONTENT--> 
                    <img id="exploring-at-circle" src="http://www.pacer.org//stc/tikes/images/ATinSchools-circle.png" width="200" height="200" alt=""/>
                    <h1>Including Assistive Technology (AT) in School</h1>

                    <p>Including AT in the schools is guided by the Individuals with Disabilities Education Act (IDEA), a federal law related to educational services for children with disabilities age birth through 21, in a process called consideration.&nbsp;
                        The consideration of assistive technology is part of the process of developing an Individual Family Service Plan (IFSP) for children ages birth to 3 and developing an Individual Education Program (IEP) for children ages 3 to 5.</p>
                    <p>Many providers are using assistive technology but may not recognize it as assistive technology. This lack of understanding about the full range and scope of assistive technology often leads to statements that there is no need for
                        assistive technology when in fact it is written throughout the IFSP or IEP document. The TIKES Project strives to help parents and providers understand the process of consideration and to properly document their consideration in the
                        IFSP and IEP.</p>
                    <h2>Including Assistive Technology in the Individual Family Service Plan (IFSP) and Individual Education Program (IEP)</h2>
                    <p> The Individuals with Disabilities Education Act (IDEA) is a federal law related to educational services for children with disabilities age birth through 21. According to this federal law, the use of assistive technology (AT) must be
                        considered during the IFSP or IEP process. However, what this consideration should look like is not outlined in the law. It is generally a short discussion during an initial or annual IFSP or IEP meeting.&nbsp; The TIKES Project has
                        created planning documents to provide families, teachers, and other professionals a way to be intentional about the process of considering assistive technology and ensure it is included in both the process and IFSP/IEP document.
                        &nbsp;</p>
                    ...
                    <div class="alertBox">
                        <p>If you use any of the TIKES materials we would love to hear how you are using them. We invite you to <a href="https://www.surveymonkey.com/r/HQ6Y3PP" target="_blank">share your feedback with us <span
                    ...
                    <ul>
                        <li class="pdficonlist">
                            ...
                            <p>AT looks different for children ages birth to 5 than it does for school aged children and adults. Learn more about measuring quality, quantity, time, effort, behavior changes, and increases in independence as you try AT with
                                your child or student. </p>
                        </li>
                        <li class="pdficonlist">
                    ...
                    <div class="documentSection">
                        ...
                        <ul>
                            ...
                            <li class="pdficonlist">
                                ...
                                <p>An expanded version of the 2-page Child-Centered AT Plan for IFSP teams that are not sure about the assistive technology available to meet the needs of the child or not sure of the assistive technology needs of the
                                    child.</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="documentSection">
                        ...
                        <ul>
                            ...
                            <li class="pdficonlist">
                                ...
                                <p>An expanded version of the 2-page Child-Centered AT Plan for IEP teams that are not sure about the assistive technology available to meet the needs of the child or not sure of the assistive technology needs of the
                                    child.</p>
                            </li>
                        </ul>
                    </div>
