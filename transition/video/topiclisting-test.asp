...
for each fitem in topicListing
	response.Write("--" & fitem & "--<br>")
next
...
<!-- Set the nav links that you want to show orange and hide any sub trees that you do not want to show -->
  ...
  <div class="content">
	...
	%>		
  		<tr>
  		<td class="topicTitle">
    	<h3><a href="/transition/video/topic.asp?se=<%=Trim(topicTitles.Item(fTopic))%>"><%=Trim(topicTitles.Item(fTopic))%></a></h3>
    	</td>
