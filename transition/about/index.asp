...
<div class="breadcrumb"> <a href="/transition/">Home</a> / </div>
  ...
  <div id="layerslider" class="loading">
    ...
    <div id="slide2" class="ls-layer" rel="slidedirection: left;">
     	<img src="/transition/about/images/aboutUs-slider/iStock_000003860077Small.jpg" alt="" width="1002" height="300" class="ls-bg" rel="delayIn: 400;"/>
    </div>
    <div id="slide3" class="ls-layer" rel="slidedirection: left;">
  ...
  <div class="content">
    <h1 id="maincontent">About Us</h1>
        ...
        <ul>
        <li class="pdficonlist"><a href="/transition/resource-library/publications/NPC-50.pdf" target="_blank">See our flyer</a></li>
        </ul>
	</div>
    ...
    <ul>
      <li>A new, cutting-edge website that inspires, educates, and engages families around transition.</li>
      <li>Technical assistance and training to professionals on best practices for engaging families, including those who are underserved.</li>
      <li>In-person and online workshops for parents of youth on topics such as assistive technology, postsecondary supports, and finding work in the community.</li>
    </ul>
    <p>We know that you have high expectations for your youth. PACER&rsquo;s National Parent Center on Transition and Employment is here to help you on your journey.</p>
