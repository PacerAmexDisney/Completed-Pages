...
function fillData(){
	...
	window.location.replace('http://www.pacer.org/housing/housingfair/organization-update-form.asp?org_id=' + mySel.options[mySel.selectedIndex].value);
}
...
<div id="maincontent">
	...
	<h1 class="nounderline">Housing  Website Information Update/Confirmation</h1>
...
%>
		...
		<table id="currInfo" cellpadding="5">
			...
			<tr>
			  <td><strong>Categories that your organization will be listed under:</strong></td><td id="c_category"><%=catList%></td></tr>
        ...
        <h3 class="ExpandHeader" style="text-transform:none;">More information about our categories your information can be listed under:        </h3>
        <div class="ExpandItem">
        <h2 class="centered">Housing and Services</h2>
        <p><strong style="font-size:1.2em;"><a href="http://www.pacer.org/housing/organizations.asp?page=Individualized-Services" target="_blank">Individualized Services</a></strong>: <br />
          Services provided to the person in which the provider  <strong>does not own</strong> the housing.</p>
          <p class="ExpandHeader"><strong>You want to be listed here if you provide services such as:</strong></p>
          <div class="ExpandItem">
          <ul>
        ...
        <p>&nbsp;</p>
        <p><strong style="font-size:1.2em;"><a href="http://www.pacer.org/housing/organizations.asp?page=Residential-Services" target="_blank">Residential  Services</a></strong>: <br />
Services provided to the person in which the provider  <strong>does own</strong> the housing.</p>
          ...
          <h2 class="centered">Information Resource and Referral</h2>
          <ul>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=Foreclosure" target="_blank">Foreclosure and Eviction</a></li>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=Financing" target="_blank">Financing</a></li>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=MN-Housing-Rights" target="_blank">MN Housing Rights and Legal Issues</a></li>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=Remodeling-Accessibility" target="_blank">Remodeling and Accessibility</a></li>
          </ul>
          <h2 class="centered">Organizations By Locale</h2>
          <ul>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=MN-Organizations" target="_blank">Minnesota Organizations</a></li>
            <li><a href="http://www.pacer.org/housing/organizations.asp?page=National-Housing" target="_blank">National Organizations</a></li>
          </ul>
          <p>&nbsp;</p>
          </div>
          <p>&nbsp;</p></td>
