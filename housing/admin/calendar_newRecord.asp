...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.Housing_EventsCalendar (eventDate, eventDateText, heading, headingLink, [description]) VALUES (?, ?, ?, ?, ?)" 
...
<title>Housing Calendar - Add Record</title>
<link href="admin_style.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
function formCancel() {
	window.location = 'http://www.pacer.org/Housing/admin/calendar_recordList.asp';
}
</script>
...
<div id="maincontent">
	...
	<div id="pagetoporange">
		...
		<div style="float:right; width:450px; text-align:right">You are currently Logged in to the Admin pages. &gt;&gt;&gt; <a href="<%= MM_Logout %>">Log Out</a></div>			<a href="../index.asp">Home</a> / <a href="../pandr/index.asp">Programs &amp; Resources</a> / <a href="../index.asp">Housing</a>/	<a href="index.asp">Admin</a>
			<h1 class="nounderline">Housing Calendar - Add Record</h1>
...
<form action="<%=MM_editAction%>" method="post" name="form1" id="form1">
	<table align="center" cellpadding="5" cellspacing="5">
		<tr valign="baseline">
			...
			<td><input type="text" name="eventDate" value="" size="60" /></td>
			<td>11/3/2010</td>
		</tr>
		<tr valign="baseline">
			<td nowrap="nowrap" align="right">Event Date Display Text:</td>
			<td><input type="text" name="eventDateText" value="" size="60" /></td>
			<td>NOV 3 - 5, 2010</td>
		</tr>
		<tr valign="baseline">
			<td nowrap="nowrap" align="right">Heading:</td>
			<td><input type="text" name="heading" value="" size="60" /></td>
			<td>27TH ANNUAL CONFERENCE AND EXHIBIT SHOW</td>
		</tr>
		<tr valign="baseline">
			<td nowrap="nowrap" align="right">HeadingLink:</td>
			<td><input type="text" name="headingLink" value="" size="60" /></td>
