...
<%
    ...
    MM_editCmd.CommandText = "DELETE FROM dbo.Housing_Providers WHERE ID = " & Request.QueryString("ID")
    MM_editCmd.Execute
    MM_editCmd.ActiveConnection.Close

Response.Redirect("providers_recordList.asp")
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Housing Delete Provider</title>
...
<div id="maincontent">
	...
	<div id="pagetoporange">
		...
		<div style="float:right; width:450px; text-align:right">You are currently Logged in to the Admin pages. &gt;&gt;&gt; <a href="<%= MM_Logout %>">Log Out</a></div>			<a href="../index.asp">Home</a> / <a href="../pandr/index.asp">Programs &amp; Resources</a> / <a href="../index.asp">Housing</a>/	<a href="index.asp">Admin</a>
			<h1 class="nounderline">Housing provider Delete</h1>
...
<p align="center"><a href="provider_recordList.asp">go back</a></p>
<p>&nbsp;</p>
