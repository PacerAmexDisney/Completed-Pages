...
<div id="mainDescription">
	...
	<ul>
		<li>Accessible &ndash; available 24 hours a day, 7 days a week in the child&rsquo;s community</em></li>
		<li>Family-Centered &ndash; recognizes the family as principal caregivers and the center of strength and support for children</li>
		<li>Continuous &ndash; available from infancy through adolescence, with the same primary pediatric health care professionals</li>
		<li>Comprehensive &ndash; includes sick and well care as well as education and community referral needs</li>
		<li>Coordinated &ndash; includes links to support, educational, and community-based services</li>
		<li>Compassionate &ndash; expresses and demonstrates concern for well-being of child and family</li>
		<li>Culturally effective &ndash; recognizes, values, and respects each family&rsquo;s cultural background</li>
	</ul>
	...
	<p><strong>What are the roles and duties for the primary care physician and other health care providers within a medical home?</strong></p>
	<ul>
	...
	<ul>
		...
		<li class="pdficonlist">Read the <a href="http://www.medicalhomeinfo.org/downloads/pdfs/JointStatement.pdf" target="_blank">Joint Principles of the Patient-Centered Medical Home</a></li>
...
National organizations providing guidance and information to medical providers and parents.</p>
 ...
 <p><a href="http://www.medicalhomeinfo.org/downloads/pdfs/NCMHI%20Retrospective_FINAL_July2013.pdf" target="_blank">A Retrospective Look at Programs and Initiatives Toward a Family-Centered Medical Home for Every Child and Youth</a><br />
   A report by the National Center for Medical Home Implementation highlighting new advances and information in Medical Home from 2008 to 2013.</p>
  <p> <a href="http://www.medicalhomeinfo.org/downloads/pdfs/MonographFINAL3.29.10.pdf" target="_blank">Measuring Medical Homes: Tools to Evaluate the Pediatric Patient and Family-Centered Medical Home</a><br />
    Presents various tools available and in use to identify, recognize, and evaluate a practice as a pediatric medical home.</p>
...
<ul>
 ...
 <li><a href="http://www.pacer.org/health/medicalhome.asp" target="_blank">Medical Home</a><br />
 PACER Health Information Center&rsquo;s webpage for families.&nbsp; Includes the importance of a medical home, components of a medical home, the roles of a medical home team, benefits and more information on building a medical home.</li>
 <li><a href="http://www.health.state.mn.us/divs/cfh/topic/medhome/" target="_blank">Medical Home for Children and Youth with Special Health Needs</a><br />
