...
<title>Subscribe to F2F Health E-news</title>
...
<script>
	$().ready(function() {
		var actionPage = "/heaxlth/newxsletxter/opxtIn-heaxlth-ebxlxasts-procexssing-djx34f.asp";
...
<img src="http://www.pacer.org/health/newsletter/images/newsletter-banner-v2.png" alt="Family To Family Health E-news" style="width:100%" border="0" />

<form id="OptInForm" action="" method="post" class="secured">

<h1>Sign Up for the F2F Health E-news</h1>
