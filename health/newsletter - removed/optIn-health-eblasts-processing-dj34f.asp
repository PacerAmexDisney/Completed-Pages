...
formTitle = "F2F Health E-news Sign Up Form"
formUrl = "http://www.pacer.org/health/newsletter/optIn-health-eblasts.asp"
...
Function ServersideValidationCheck
  ...
  If isValid = "" Then
	...
	' Send Mail
	content = "Please add me to the Eblast, and Health E-News newletters in PCIS.  Thanks." & VbCrLf & VbCrLf & VbCrLf
	...
	footer = vbCrLf & vbCrLf & vbCrLf & "* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *" & vbCrLf & vbCrLf & "This form came from " & formUrl
		...
		myMail.Subject = "Health E-News Sign Up"
...
<title>Subscribe to Health E-News Mailings Processing - PACER Center</title>
