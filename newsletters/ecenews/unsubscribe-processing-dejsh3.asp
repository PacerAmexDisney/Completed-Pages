...
formTitle = "Opt Out of Early Childhood E-News"
formUrl = "http://www.pacer.org/newsletters/ecenews/unsubscribe.asp"
...
Function ServersideValidationCheck
  ...
  If isValid = "" Then
	...
	content = content & "Please remove me from the Early Childhood E-News check box under the Mail List Tab in PCIS"
	footer = vbCrLf & vbCrLf & vbCrLf & "* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *" & vbCrLf & vbCrLf & "This form came from " & formUrl
		...
		myMail.Subject = "Remove me from Early Childhood E-News mail list"
...
<title>Opt Out of Early Childhood E-News Processing - PACER Center</title>
...
<div id="maincontent">
	...
	<div id="breadcrumb">
		<a href="/">Home</a>/ <a href="/newsletters/">Newsletters</a> / <a href="/newsletters/ecenews/">Early Childhood E-News</a> /
<h1 class="nounderline">Unsubscribe from PACER's Early Childhood E-News</h1>
