...
formTitle = "Opt Out of Enews Newsletter Mailing List"
formUrl = "http://www.pacer.org/newsletters/enews/unsubscribe.asp"
...
Function ServersideValidationCheck
  ...
  If isValid = "" Then
  	isValid = "True"
	' Send Mail
	content = "Name: " & strname & "<br><br>" & vbCrLf
	content = content & "E-mail Address: " & strEmail & "<br><br>" & vbCrLf
	content = content & "Please remove my Subscription from the E-News check box under the Mail List Tab in PIX" & "<br><br>"
	footer = vbCrLf & vbCrLf & vbCrLf & "* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *" & vbCrLf & vbCrLf & "This form came from " & formUrl
		...
		myMail.Subject = "Remove me to the Pacer E-News mailing list"
