...
<title>Early Childhood - E-News</title>
...
<div id="rightBar">
  ...
  <p class="stayinformed"> <em>As a parent of a child with a chronic illness, information is essential because it provides me with education I need to make decisions for my child's care. Access to this information is vital because it helps me navigate the health care system and achieve the best care possible for my child.</em><br />
    <br />
    - Carolyn G. </p>
<div class="sidebarwithimage"><img src="/ec/images/Baby-holding-hands.jpg" width="200" height="200" alt="" /></div>    
...
<!--BEGIN CONTENT-->
<p style="text-align:center"><a href="/publications/">View Our Full  Catalog </a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="/forms/request.asp">Reprint Request Form</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<img src="/images/pdficon_small.gif" width="15" height="15" alt="" /><a href="/forms/request.asp">Publications Order Form</a></p>
<div id="importContent" class="newsblock"><p style="text-align:center; margin:25px;">Loading Content ...</p></div>


<script type="text/javascript">
$('#importContent').load('/publications/earlyChildhood.asp #pagecontent');
</script>
